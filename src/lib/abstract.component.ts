...
export abstract class AbstractComponent implements OnDestroy {
        ...
        this._zone.runOutsideAngular(() => {
            ...
            this._unlisteners.push(this._renderer.listen(this._elem, 'dragstart', (event: DragEvent) => {
                ...
                if (event.dataTransfer != null) {
                    ...
                    if (isPresent(this.dragImage)) {
                        ...
                        this._renderer.appendChild(this._elem.parentElement, this._dragHelper);
            ...
            this._unlisteners.push(this._renderer.listen(this._elem, 'dragend', (event: Event) => {
                if (this._elem.parentElement && this._dragHelper) {
                    this._renderer.removeChild(this._elem.parentElement, this._dragHelper);
                }
    ...
    //**** Drop Callbacks ****//
    _onDragEnterCallback(_event: Event) { }
    _onDragOverCallback(_event: Event) { }
    _onDragLeaveCallback(_event: Event) { }
    _onDropCallback(_event: Event) { }

    //**** Drag Callbacks ****//
    _onDragStartCallback(_event: Event) { }
    _onDragEndCallback(_event: Event) { }
}
