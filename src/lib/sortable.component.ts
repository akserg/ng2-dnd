...
export class SortableContainer extends AbstractComponent {
    ...
    override _onDragEnterCallback(_event: Event) {
...
export class SortableComponent extends AbstractComponent {
    ...
    override _onDragStartCallback(_event: Event) {
        // console.log('_onDragStartCallback. dragging elem with index ' + this.index);
        this._sortableDataService.isDragged = true;
        this._sortableDataService.sortableContainer = this._sortableContainer;
        this._sortableDataService.index = this.index;
        this._sortableDataService.markSortable(this._elem, this.renderer);
        // Add dragData
    ...
    override _onDragOverCallback(_event: Event) {
    ...
    override _onDragEndCallback(_event: Event) {
        // console.log('_onDragEndCallback. end dragging elem with index ' + this.index);
        this._sortableDataService.isDragged = false;
        this._sortableDataService.sortableContainer = null;
        this._sortableDataService.index = null;
        this._sortableDataService.markSortable(null, this.renderer);
        // Add dragGata
    ...
    override _onDropCallback(_event: Event) {
        if (this._sortableDataService.isDragged) {
